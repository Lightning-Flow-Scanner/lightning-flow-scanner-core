...
/* harmony export */   "MK": () => (/* reexport safe */ _models_FlowType__WEBPACK_IMPORTED_MODULE_0__.M),
/* harmony export */   "Ml": () => (/* reexport safe */ _models_ScanResult__WEBPACK_IMPORTED_MODULE_7__.M),
/* harmony export */   "Si": () => (/* reexport safe */ _libs_Compiler__WEBPACK_IMPORTED_MODULE_6__.S),
/* harmony export */   "Tt": () => (/* reexport safe */ _models_FlowAttribute__WEBPACK_IMPORTED_MODULE_1__.T),
/* harmony export */   "Zw": () => (/* reexport safe */ _models_Flow__WEBPACK_IMPORTED_MODULE_5__.Z),
/* harmony export */   "_6": () => (/* reexport safe */ _models_RuleResult__WEBPACK_IMPORTED_MODULE_8__._),
/* harmony export */   "jC": () => (/* reexport safe */ _models_FlowNode__WEBPACK_IMPORTED_MODULE_2__.j),
/* harmony export */   "lf": () => (/* reexport safe */ _models_FlowResource__WEBPACK_IMPORTED_MODULE_4__.l),
/* harmony export */   "q8": () => (/* reexport safe */ _models_ResultDetails__WEBPACK_IMPORTED_MODULE_9__.q),
/* harmony export */   "tw": () => (/* reexport safe */ _models_FlowVariable__WEBPACK_IMPORTED_MODULE_3__.t)
/* harmony export */ });
/* harmony import */ var _libs_Compiler__WEBPACK_IMPORTED_MODULE_6__ = __nccwpck_require__(450);
/* harmony import */ var _models_Flow__WEBPACK_IMPORTED_MODULE_5__ = __nccwpck_require__(318);
/* harmony import */ var _models_FlowAttribute__WEBPACK_IMPORTED_MODULE_1__ = __nccwpck_require__(80);
/* harmony import */ var _models_FlowType__WEBPACK_IMPORTED_MODULE_0__ = __nccwpck_require__(929);
/* harmony import */ var _models_FlowNode__WEBPACK_IMPORTED_MODULE_2__ = __nccwpck_require__(145);
/* harmony import */ var _models_FlowResource__WEBPACK_IMPORTED_MODULE_4__ = __nccwpck_require__(526);
/* harmony import */ var _models_FlowVariable__WEBPACK_IMPORTED_MODULE_3__ = __nccwpck_require__(455);
/* harmony import */ var _models_ResultDetails__WEBPACK_IMPORTED_MODULE_9__ = __nccwpck_require__(995);
/* harmony import */ var _models_RuleResult__WEBPACK_IMPORTED_MODULE_8__ = __nccwpck_require__(379);
/* harmony import */ var _models_ScanResult__WEBPACK_IMPORTED_MODULE_7__ = __nccwpck_require__(992);
...
/* harmony export */ __nccwpck_require__.d(__webpack_exports__, {
/* harmony export */   "S": () => (/* binding */ Compiler)
/* harmony export */ });
/* harmony import */ var _models_FlowNode__WEBPACK_IMPORTED_MODULE_0__ = __nccwpck_require__(145);
        ...
        while (elementsToVisit.length > 0) {
            ...
            for (const elementName of elementsToVisit) {
                if (!this.visitedElements.has(elementName)) {
                    const currentElement = flow.elements.find(element => element instanceof _models_FlowNode__WEBPACK_IMPORTED_MODULE_0__/* .FlowNode */ .j && element.name === elementName);
                    if (currentElement) {
        ...
        if (currentElement.connectors && currentElement.connectors.length > 0) {
            for (const connector of currentElement.connectors) {
                if (connector.reference) {
                    ...
                    const nextElement = flow.elements.find(element => element instanceof _models_FlowNode__WEBPACK_IMPORTED_MODULE_0__/* .FlowNode */ .j && element.name === connector.reference);
                    if (nextElement instanceof _models_FlowNode__WEBPACK_IMPORTED_MODULE_0__/* .FlowNode */ .j && nextElement.name !== endElementName) {
...
// EXTERNAL MODULE: ./out/main/models/FlowNode.js + 1 modules
var FlowNode = __nccwpck_require__(145);
// EXTERNAL MODULE: ./out/main/models/FlowElement.js
var FlowElement = __nccwpck_require__(930);
;// CONCATENATED MODULE: ./out/main/models/FlowMetadata.js

class FlowMetadata extends FlowElement/* FlowElement */.e {
    constructor(subtype, element) {
        super('metadata', subtype, element);
    }
}
//# sourceMappingURL=FlowMetadata.js.map
// EXTERNAL MODULE: ./out/main/models/FlowVariable.js
var FlowVariable = __nccwpck_require__(455);
// EXTERNAL MODULE: ./out/main/models/FlowResource.js
var FlowResource = __nccwpck_require__(526);
;// CONCATENATED MODULE: ./out/main/models/Flow.js
...
class Flow {
    ...
    preProcessNodes() {
        ...
        for (const nodeType in this.xmldata) {
            ...
            if (this.flowMetadata.includes(nodeType)) {
                ...
                if (Array.isArray(data)) {
                    for (const node of data) {
                        allNodes.push(new FlowVariable/* FlowVariable */.t(node.name, nodeType, node));
                    }
                }
                else {
                    allNodes.push(new FlowVariable/* FlowVariable */.t(data.name, nodeType, data));
                }
            }
            else if (this.flowNodes.includes(nodeType)) {
                if (Array.isArray(data)) {
                    for (const node of data) {
                        allNodes.push(new FlowNode/* FlowNode */.j(node.name, nodeType, node));
                    }
                }
                else {
                    allNodes.push(new FlowNode/* FlowNode */.j(data.name, nodeType, data));
                }
            }
            else if (this.flowResources.includes(nodeType)) {
                if (Array.isArray(data)) {
                    for (const node of data) {
                        allNodes.push(new FlowResource/* FlowResource */.l(node.name, nodeType, node));
                    }
                }
                else {
                    allNodes.push(new FlowResource/* FlowResource */.l(data.name, nodeType, data));
                }
            }
        }
    ...
    findStart() {
        let start = "";
        const flowElements = this.elements.filter((node) => node instanceof FlowNode/* FlowNode */.j);
...
/* harmony export */ __nccwpck_require__.d(__webpack_exports__, {
/* harmony export */   "T": () => (/* binding */ FlowAttribute)
/* harmony export */ });
class FlowAttribute {
...
/* harmony export */ __nccwpck_require__.d(__webpack_exports__, {
/* harmony export */   "e": () => (/* binding */ FlowElement)
/* harmony export */ });
class FlowElement {
...
;// CONCATENATED MODULE: ./out/main/models/FlowElementConnector.js
...
// EXTERNAL MODULE: ./out/main/models/FlowElement.js
var FlowElement = __nccwpck_require__(930);
;// CONCATENATED MODULE: ./out/main/models/FlowNode.js


class FlowNode extends FlowElement/* FlowElement */.e {
...
/* harmony export */ __nccwpck_require__.d(__webpack_exports__, {
/* harmony export */   "l": () => (/* binding */ FlowResource)
/* harmony export */ });
/* harmony import */ var _FlowElement__WEBPACK_IMPORTED_MODULE_0__ = __nccwpck_require__(930);

class FlowResource extends _FlowElement__WEBPACK_IMPORTED_MODULE_0__/* .FlowElement */ .e {
...
/* harmony export */ __nccwpck_require__.d(__webpack_exports__, {
/* harmony export */   "M": () => (/* binding */ FlowType)
/* harmony export */ });
class FlowType {
}
...
/* harmony export */ __nccwpck_require__.d(__webpack_exports__, {
/* harmony export */   "t": () => (/* binding */ FlowVariable)
/* harmony export */ });
/* harmony import */ var _FlowElement__WEBPACK_IMPORTED_MODULE_0__ = __nccwpck_require__(930);

class FlowVariable extends _FlowElement__WEBPACK_IMPORTED_MODULE_0__/* .FlowElement */ .e {
    constructor(name, subtype, element) {
...
/* harmony export */ __nccwpck_require__.d(__webpack_exports__, {
/* harmony export */   "q": () => (/* binding */ ResultDetails)
/* harmony export */ });
class ResultDetails {
...
/* harmony export */ __nccwpck_require__.d(__webpack_exports__, {
/* harmony export */   "y": () => (/* binding */ RuleCommon)
/* harmony export */ });
class RuleCommon {
...
/* harmony export */ __nccwpck_require__.d(__webpack_exports__, {
/* harmony export */   "_": () => (/* binding */ RuleResult)
/* harmony export */ });
class RuleResult {
...
/* harmony export */ __nccwpck_require__.d(__webpack_exports__, {
/* harmony export */   "M": () => (/* binding */ ScanResult)
/* harmony export */ });
class ScanResult {
...
/* harmony export */ __nccwpck_require__.d(__webpack_exports__, {
/* harmony export */   "J": () => (/* binding */ APIVersion)
/* harmony export */ });
/* harmony import */ var _internals_internals__WEBPACK_IMPORTED_MODULE_0__ = __nccwpck_require__(902);
/* harmony import */ var _models_RuleCommon__WEBPACK_IMPORTED_MODULE_1__ = __nccwpck_require__(180);


class APIVersion extends _models_RuleCommon__WEBPACK_IMPORTED_MODULE_1__/* .RuleCommon */ .y {
    constructor() {
        super({
            name: 'APIVersion',
            ...
            supportedTypes: _internals_internals__WEBPACK_IMPORTED_MODULE_0__/* .FlowType.allTypes */ .MK.allTypes(),
            docRefs: [],
            isConfigurable: true,
            autoFixable: false
        });
        ...
        if (flowAPIVersionNumber) {
            if (options && options.expression) {
                ...
                return (!expressionEvaluation ?
                    new _internals_internals__WEBPACK_IMPORTED_MODULE_0__/* .RuleResult */ ._6(this, [new _internals_internals__WEBPACK_IMPORTED_MODULE_0__/* .ResultDetails */ .q8(new _internals_internals__WEBPACK_IMPORTED_MODULE_0__/* .FlowAttribute */ .Tt(!expressionEvaluation ? ('' + flowAPIVersionNumber) : undefined, "apiVersion", options.expression))]) :
                    new _internals_internals__WEBPACK_IMPORTED_MODULE_0__/* .RuleResult */ ._6(this, []));
            }
            else {
                return new _internals_internals__WEBPACK_IMPORTED_MODULE_0__/* .RuleResult */ ._6(this, []);
            }
        }
        else {
            return new _internals_internals__WEBPACK_IMPORTED_MODULE_0__/* .RuleResult */ ._6(this, [new _internals_internals__WEBPACK_IMPORTED_MODULE_0__/* .ResultDetails */ .q8(new _internals_internals__WEBPACK_IMPORTED_MODULE_0__/* .FlowAttribute */ .Tt('API Version <49', "apiVersion", "<49"))]);
        }
    }
}
...
// EXPORTS
__nccwpck_require__.d(__webpack_exports__, {
  "Compiler": () => (/* reexport */ Compiler/* Compiler */.S),
  "Flow": () => (/* reexport */ Flow/* Flow */.Z),
  "FlowAttribute": () => (/* reexport */ FlowAttribute/* FlowAttribute */.T),
  "FlowElement": () => (/* reexport */ FlowElement/* FlowElement */.e),
  "FlowNode": () => (/* reexport */ FlowNode/* FlowNode */.j),
  "FlowResource": () => (/* reexport */ FlowResource/* FlowResource */.l),
  "FlowType": () => (/* reexport */ FlowType/* FlowType */.M),
  "FlowVariable": () => (/* reexport */ FlowVariable/* FlowVariable */.t),
  "ResultDetails": () => (/* reexport */ ResultDetails/* ResultDetails */.q),
  "RuleResult": () => (/* reexport */ RuleResult/* RuleResult */._),
  "ScanResult": () => (/* reexport */ ScanResult/* ScanResult */.M),
  "fix": () => (/* binding */ fix),
  "getRules": () => (/* binding */ getRules),
  "scan": () => (/* binding */ scan)
});

;// CONCATENATED MODULE: ./out/main/libs/ConvertFlowNodes.js
function convertFlowNodes(obj, nodes, key) {
    obj[key] = nodes.map(node => node.element);
    return obj;
}
//# sourceMappingURL=ConvertFlowNodes.js.map
;// CONCATENATED MODULE: ./out/main/libs/BuildFlow.js
...
// EXTERNAL MODULE: ./out/main/internals/internals.js
var internals = __nccwpck_require__(902);
;// CONCATENATED MODULE: ./out/main/libs/FixFlows.js
...
function FixFlows(flow, ruleResults) {
    ...
    const newFlow = new internals/* Flow */.Zw(flow.name, xmldata);
    return newFlow;
}
//# sourceMappingURL=FixFlows.js.map
// EXTERNAL MODULE: ./out/main/rules/APIVersion.js
var APIVersion = __nccwpck_require__(590);
// EXTERNAL MODULE: ./out/main/models/RuleCommon.js
var RuleCommon = __nccwpck_require__(180);
;// CONCATENATED MODULE: ./out/main/rules/AutoLayout.js


class AutoLayout extends RuleCommon/* RuleCommon */.y {
    constructor() {
        super({
            name: 'AutoLayout',
            ...
            supportedTypes: internals/* FlowType.allTypes */.MK.allTypes(),
            docRefs: [],
            isConfigurable: true,
            autoFixable: false
        });
    ...
    execute(flow, options) {
        ...
        if (flow.processMetadataValues) {
            ...
            return (!AutoLayout ?
                new internals/* RuleResult */._6(this, [new internals/* ResultDetails */.q8(new internals/* FlowAttribute */.Tt((_a = CanvasMode.value) === null || _a === void 0 ? void 0 : _a.stringValue, "CanvasMode", '!== AUTO_LAYOUT_CANVAS'))]) :
                new internals/* RuleResult */._6(this, []));
        }
    }
}
//# sourceMappingURL=AutoLayout.js.map
;// CONCATENATED MODULE: ./out/main/rules/CopyAPIName.js


class CopyAPIName extends RuleCommon/* RuleCommon */.y {
    constructor() {
        super({
            name: 'CopyAPIName',
            label: 'Copy API Name',
    ...
    execute(flow) {
        const flowElements = flow.elements.filter(node => node instanceof internals/* FlowNode */.jC);
        ...
        for (const det of copyOfElements) {
            results.push(new internals/* ResultDetails */.q8(det));
        }
        return new internals/* RuleResult */._6(this, results);
    }
}
//# sourceMappingURL=CopyAPIName.js.map
;// CONCATENATED MODULE: ./out/main/rules/DMLStatementInLoop.js


class DMLStatementInLoop extends RuleCommon/* RuleCommon */.y {
    constructor() {
        super({
            ...
            supportedTypes: internals/* FlowType.backEndTypes */.MK.backEndTypes,
    ...
    execute(flow) {
        ...
        for (const element of loopElements) {
            ...
            new internals/* Compiler */.Si().traverseFlow(flow, element.name, findDML, loopEnd);
        }
        // Create result details
        const results = dmlStatementsInLoops.map(det => new internals/* ResultDetails */.q8(det));
        return new internals/* RuleResult */._6(this, results);
    }
}
//# sourceMappingURL=DMLStatementInLoop.js.map
;// CONCATENATED MODULE: ./out/main/rules/DuplicateDMLOperation.js


class DuplicateDMLOperation extends RuleCommon/* RuleCommon */.y {
    constructor() {
        super({
            ...
            supportedTypes: internals/* FlowType.visualTypes */.MK.visualTypes,
            docRefs: [],
            isConfigurable: false,
            autoFixable: false,
        });
...
;// CONCATENATED MODULE: ./out/main/rules/FlowDescription.js


class FlowDescription extends RuleCommon/* RuleCommon */.y {
    constructor() {
        super({
            ...
            supportedTypes: [...internals/* FlowType.backEndTypes */.MK.backEndTypes, ...internals/* FlowType.visualTypes */.MK.visualTypes],
            docRefs: [],
            isConfigurable: false,
            autoFixable: false
        });
    ...
    execute(flow) {
        ...
        return (missingFlowDescription ?
            new internals/* RuleResult */._6(this, [new internals/* ResultDetails */.q8(new internals/* FlowAttribute */.Tt('undefined', "description", "!==null"))]) :
            new internals/* RuleResult */._6(this, []));
    }
}
//# sourceMappingURL=FlowDescription.js.map
;// CONCATENATED MODULE: ./out/main/rules/FlowName.js


class FlowName extends RuleCommon/* RuleCommon */.y {
    constructor() {
        super({
            name: 'FlowName',
...
class HardcodedId extends RuleCommon/* RuleCommon */.y {
    ...
    execute(flow) {
        const prefixes = IdPrefixes_namespaceObject.r.map(prefix => {
...
;// CONCATENATED MODULE: ./out/main/rules/InactiveFlow.js


class InactiveFlow extends RuleCommon/* RuleCommon */.y {
    constructor() {
        super({
            name: 'InactiveFlow',
            label: 'Inactive Flow',
...
;// CONCATENATED MODULE: ./out/main/rules/MissingFaultPath.js


class MissingFaultPath extends RuleCommon/* RuleCommon */.y {
    constructor() {
        super({
    ...
    execute(flow) {
        const compiler = new internals/* Compiler */.Si();
        const results = [];
        const elementsWhereFaultPathIsApplicable = flow.elements.filter((node) => node instanceof internals/* FlowNode */.jC && ['recordLookups', 'recordDeletes', 'recordUpdates', 'recordCreates', 'waits', 'actionCalls'].includes(node.subtype)).map((e) => e.name);
        const visitCallback = (element) => {
            ...
            if (!element.connectors.find((connector) => connector.type === 'faultConnector') && elementsWhereFaultPathIsApplicable.includes(element.name)) {
                ...
                if (!this.isPartOfFaultHandlingFlow(element, flow)) {
                    results.push(new internals/* ResultDetails */.q8(element));
                }
            }
        };
    ...
    isPartOfFaultHandlingFlow(element, flow) {
        const flowelements = flow.elements.filter(el => el instanceof internals/* FlowNode */.jC);
...
;// CONCATENATED MODULE: ./out/main/rules/MissingNullHandler.js


class MissingNullHandler extends RuleCommon/* RuleCommon */.y {
    constructor() {
        super({
...
;// CONCATENATED MODULE: ./out/main/rules/ProcessBuilder.js


class ProcessBuilder extends RuleCommon/* RuleCommon */.y {
    constructor() {
        super({
            name: 'ProcessBuilder',
            ...
            supportedTypes: internals/* FlowType.processBuilder */.MK.processBuilder,
    ...
    execute(flow, options) {
        return new internals/* RuleResult */._6(this, [new internals/* ResultDetails */.q8(new internals/* FlowAttribute */.Tt('Workflow', "processType", '== Workflow'))]);
    }
}
//# sourceMappingURL=ProcessBuilder.js.map
;// CONCATENATED MODULE: ./out/main/rules/SOQLQueryInLoop.js


class SOQLQueryInLoop extends RuleCommon/* RuleCommon */.y {
    constructor() {
        super({
    ...
    execute(flow) {
        ...
        // Create result details
        const results = soqlStatementsInLoops.map(det => new internals/* ResultDetails */.q8(det));
        return new internals/* RuleResult */._6(this, results);
    }
}
//# sourceMappingURL=SOQLQueryInLoop.js.map
;// CONCATENATED MODULE: ./out/main/rules/UnconnectedElement.js


class UnconnectedElement extends RuleCommon/* RuleCommon */.y {
    constructor() {
        super({
    ...
    execute(flow) {
        ...
        if (startIndex !== -1) {
            new internals/* Compiler */.Si().traverseFlow(flow, flowElements[startIndex].name, logConnected);
        }
        const unconnectedElements = flowElements.filter(element => !connectedElements.has(element.name));
        // Create result details
        const results = unconnectedElements.map(det => new internals/* ResultDetails */.q8(det));
        return new internals/* RuleResult */._6(this, results);
    }
    findStart(nodes) {
...
;// CONCATENATED MODULE: ./out/main/rules/UnusedVariable.js


class UnusedVariable extends RuleCommon/* RuleCommon */.y {
    constructor() {
        super({
            name: 'UnusedVariable',
    ...
    execute(flow) {
        ...
        for (const variable of flow.elements.filter(node => node instanceof internals/* FlowVariable */.tw)) {
            const variableName = variable.name;
            if ([...JSON.stringify(flow.elements.filter(node => node instanceof internals/* FlowNode */.jC)).matchAll(new RegExp(variableName, 'gi'))].map(a => a.index).length === 0) {
                // if not found in any inside of flow elements
                if ([...JSON.stringify(flow.elements.filter(node => node instanceof internals/* FlowResource */.lf)).matchAll(new RegExp(variableName, 'gi'))].map(a => a.index).length === 0) {
                    const insideCounter = [...JSON.stringify(variable).matchAll(new RegExp(variable.name, 'gi'))].map(a => a.index);
                    const variableUsage = [...JSON.stringify(flow.elements.filter(node => node instanceof internals/* FlowVariable */.tw)).matchAll(new RegExp(variableName, 'gi'))].map(a => a.index);
...
;// CONCATENATED MODULE: ./out/main/store/DefaultRuleStore.js
...
const DefaultRuleStore = {
    APIVersion: APIVersion/* APIVersion */.J,
    AutoLayout: AutoLayout,
    CopyAPIName: CopyAPIName,
    DMLStatementInLoop: DMLStatementInLoop,
    DuplicateDMLOperation: DuplicateDMLOperation,
    ...
    SOQLQueryInLoop: SOQLQueryInLoop,
    UnconnectedElement: UnconnectedElement,
    UnusedVariable: UnusedVariable,
    InactiveFlow: InactiveFlow,
};
//# sourceMappingURL=DefaultRuleStore.js.map
;// CONCATENATED MODULE: ./out/main/libs/DynamicRule.js
...
;// CONCATENATED MODULE: ./out/main/libs/GetRuleDefinitions.js
...
;// CONCATENATED MODULE: ./out/main/libs/ScanFlows.js
        ...
        for (const rule of selectedRules) {
            try {
                if (rule.supportedTypes.includes(flow.type)) {
                    ...
                    ruleResults.push(new internals/* RuleResult */._6(rule, []));
                }
            }
            catch (error) {
                let message = "Something went wrong while executing " +
                    ...
                    " in the Flow: '" +
                    flow.name;
                ruleResults.push(new internals/* RuleResult */._6(rule, [], message));
            }
        }
        flowResults.push(new internals/* ScanResult */.Ml(flow, ruleResults));
    }
    return flowResults;
}
//# sourceMappingURL=ScanFlows.js.map
// EXTERNAL MODULE: ./out/main/models/Flow.js + 1 modules
var Flow = __nccwpck_require__(318);
// EXTERNAL MODULE: ./out/main/models/FlowAttribute.js
var FlowAttribute = __nccwpck_require__(80);
// EXTERNAL MODULE: ./out/main/models/FlowElement.js
var FlowElement = __nccwpck_require__(930);
// EXTERNAL MODULE: ./out/main/models/FlowNode.js + 1 modules
var FlowNode = __nccwpck_require__(145);
// EXTERNAL MODULE: ./out/main/models/FlowResource.js
var FlowResource = __nccwpck_require__(526);
// EXTERNAL MODULE: ./out/main/models/FlowType.js
var FlowType = __nccwpck_require__(929);
// EXTERNAL MODULE: ./out/main/models/FlowVariable.js
var FlowVariable = __nccwpck_require__(455);
// EXTERNAL MODULE: ./out/main/libs/Compiler.js
var Compiler = __nccwpck_require__(450);
// EXTERNAL MODULE: ./out/main/models/ScanResult.js
var ScanResult = __nccwpck_require__(992);
// EXTERNAL MODULE: ./out/main/models/RuleResult.js
var RuleResult = __nccwpck_require__(379);
// EXTERNAL MODULE: ./out/main/models/ResultDetails.js
var ResultDetails = __nccwpck_require__(995);
